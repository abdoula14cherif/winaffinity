...
from app.routes import auth, payment, dashboard, withdrawal, gains, pages, admin, notifications, wheel, network, learning, admin_user, contest, support, push, password_reset, wallet, flash, social
